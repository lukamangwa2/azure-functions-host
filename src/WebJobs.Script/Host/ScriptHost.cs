...
namespace Microsoft.Azure.WebJobs.Script
{
    public class ScriptHost : JobHost, IScriptJobHost
    {
        ...
        private const int DelayedFileWatchersDelaySeconds = 30;
        ...
        /// </summary>
        private void DelayedCleanupFileSystem()
        {
            ...
            }, TimeSpan.FromSeconds(DelayedFileWatchersDelaySeconds));
        }
